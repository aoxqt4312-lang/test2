...
public class MainActivity extends Activity {
    ...
    "What it's for:\n" +
    "For everyday use and preparedness for situations where you might be forced to unlock your phone. When could this happen? Almost always. You go to the mall. And there was a major accident. Everyone who was there came under scrutiny. You were walking in the woods, and someone recently went missing there. And you came under scrutiny. If you show your phone, you'll have problems for other reasons. Your interests, messages—all of that can be used against you. This is the real goal of such measures. If you wipe the data, it can't be used against you. There's not enough information here for them to do anything with it. The fact that the data is wiped means absolutely nothing. You just don't want anyone snooping through your personal life. This is your constitutional right.\n" +
